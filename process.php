...
?>
        ...
        <div class="col-lg-8">
            ...
            if(isset($_GET['from_city'])===true 
              ...
              <input type="hidden" name="count_c" value="<?php echo $countc; ?>"/>
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
		                <div class="col-lg-12">
		                  <label class="control-label" for="focusedInput">Nat ID: </label>
		  ...
		  /* Flight search Round Trip with booking form*/
              ...
              <input type="hidden" name="count_a" value="<?php echo $counta; ?>"/>
              <input type="hidden" name="count_c" value="<?php echo $countc; ?>"/>
			  		<h3>If yu a guest user please Register and proceed to book your ticket</h3>
              ...
              <h
              <h5>We are the best Thing Flying</h5>
              <h5>Discounted travel coupons for every city</h5>
              <h5>Book a ticket on our webiste and stand a chance to win a plane</h5>
              <h5>Emergency services for disabled at free of cost</h5>
            </form>
          </div>
        </div>
